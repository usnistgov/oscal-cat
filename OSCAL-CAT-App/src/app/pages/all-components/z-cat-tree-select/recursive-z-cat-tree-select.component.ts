...
// import { Control } from '../../interfaces/oscal-catalog.types';
...
@Component({
    selector: '[recursive-z-cat-tree-select]',
    templateUrl: './recursive-z-cat-tree-select.component.html',
    styleUrls: ['../action-all-common/tree-styles.scss'],
})
export class RecursiveZCatTreeSelectComponent {
    @Input() level: number;
    @Input() label: string;
    ...
    constructor(public router: Router, public cat: CatalogService) {
